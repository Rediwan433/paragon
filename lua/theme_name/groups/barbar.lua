...
function M.get(c, opts)
	return {
		...
		BufferCurrentMod = { bg = c.bg, fg = c.info },
		...
		BufferVisibleMod = { bg = c.highlight_low, fg = c.info },
		...
		BufferAlternateMod = { bg = c.surface, fg = c.info },
		...
		BufferInactiveMod = { bg = c.surface, fg = c.info },
