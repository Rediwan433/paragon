...
function M.get(c, opts)
	return {
		...
		SnacksDashboardHeader = { fg = c.fg_dim, bold = true },
		...
		SnacksNotifierBorderTrace = { fg = c.semantic, bg = opts.transparent and c.none or c.bg },
		SnacksNotifierIconTrace = { fg = c.semantic },
		SnacksNotifierTitleTrace = { fg = c.semantic },
		...
		SnacksPickerPickWinCurrent = { fg = c.fg, bg = c.purple, bold = true },
		...
		SnacksIndent1 = { fg = c.purple, nocombine = true },
		SnacksIndent2 = { fg = c.cyan, nocombine = true },
		SnacksIndent3 = { fg = c.teal, nocombine = true },
		SnacksIndent4 = { fg = c.green, nocombine = true },
		SnacksIndent5 = { fg = c.yellow, nocombine = true },
		SnacksIndent6 = { fg = c.orange, nocombine = true },
		SnacksIndent7 = { fg = c.red, nocombine = true },
