local Util = require("paragon.util")
...
function M.get_group(name)
	---@type {get: paragon.HighlightsFn, url: string}
	return Util.mod("paragon.groups." .. name)
end

---@param colors paragon.ColorScheme
